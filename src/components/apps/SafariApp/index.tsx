...
> = {
  projectBankingApp: {
    ...
    subtitle: "Experience-focused finance platform",
    url: "https://start.zaazhafrnn.dev/neo-banking",
    status: "ready",
    summary:
      "Designed transitions, dashboard UX, and the design system underneath the experience.",
  },
  projectB: {
...
const SafariApp: React.FC<SafariAppProps> = ({ project, onBack }) => {
  ...
  return (
    <div className="h-full w-full">
      <Safari url={meta?.url ?? project} className="size-full">
