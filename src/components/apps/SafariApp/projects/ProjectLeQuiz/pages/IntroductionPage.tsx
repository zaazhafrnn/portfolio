    ...
    <section className="space-y-6">
      <ScrollArea>
        ...
        <div className="space-y-4">
          ...
          <div className="w-full flex gap-4 mt-6" style={{ height: "75vh", minHeight: "500px" }}>
            ...
            <div className="flex-1 h-full">
              <div className="flex flex-col gap-3 h-full overflow-y-auto pr-2" style={{ scrollbarWidth: "thin" }}>
